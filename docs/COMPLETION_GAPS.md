...
Date: 2026-09-24. Reviewed SHA: [`be5d53bc928b9ed641332db48d849354d0d5d0bb`](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/commit/be5d53bc928b9ed641332db48d849354d0d5d0bb).
...
Experimental native Hydra effects for the Noisemaker engine. This is a module and browser bundle, not a complete Hydra editor. [Contract](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md).
...
|---|---|---|---|---|
| CLAIM-001 | [Historical source](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md) | Exact browser pixel comparisons against upstream Hydra, including native-to-Hydra and Hydra-to-native transitions. | partial | 30 Node tests passed. The browser pixel sweep was not executed. |
| CLAIM-002 | [README](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md) | Human usability: installation, output, errors, and recovery | unverified | Complete installed workflows were not observed. GAP-002. |
...
| CLAIM-004 | [README](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md) | Release readiness | unverified | Metadata and CI do not replace installation of the actual artifact. GAP-003. |
| CLAIM-005 | [Exact-source Actions](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/actions?query=head_sha%3Abe5d53bc928b9ed641332db48d849354d0d5d0bb) | Workflow status only | unverified | No Actions runs were returned at this source SHA. |

## 3. Methods and evidence

Environment: macOS 26.5, Darwin arm64.
[Source SHA-256 records](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/noisemaker-for-hydra-synth-source-hashes.json) bind these checks to the reviewed revision.
[Raw command evidence](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/hydra-synth-tests.json). [Remote evidence](/Users/alex/.codex/automations/noisemaker-port-completion-audit/evidence-20260924-remaining-gap-documents/noisemaker-for-hydra-synth-remote.json).
...
30 Node tests passed. The browser pixel sweep was not executed. Final exit code: 0.
...
| First useful output | Selected checks only | Install the local package, render the README hydraOsc example, change frequency, mix a native effect, and recover from invalid DSL. |
...
| Distribution | Metadata inspection | Pack the module into an isolated consumer. Check ESM and browser entry points, generated bundle presence, license files, and removal. |
...
- Affected scope: src/engine/index.js, scripts/test.mjs, package.json, dist/, README.md
- Expected behavior: Reproducible evidence binds each supported claim to the port and authority revisions.
- Observed behavior: Rolling engine and legacy reference paths do not alone identify reproducible comparison inputs. The browser gate remains unverified in this pass.
- Evidence: [Historical source](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md) and section 3.
- Next action: Resolve and retain the legacy Hydra SHA. Run the 58-case browser gate and inspect each comparison, including surface transitions.
...
- Evidence: [README](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md), [official reference](https://hydra.ojack.xyz/docs/docs/learning/getting-started/), and section 3.
- Next action: Install the local package, render the README hydraOsc example, change frequency, mix a native effect, and recover from invalid DSL.
...
- Evidence: [Distribution instructions](https://github.com/noisefactorllc/noisemaker-for-hydra-synth/blob/be5d53bc928b9ed641332db48d849354d0d5d0bb/README.md), section 1, and exact-source CI in section 2.
- Next action: Pack the module into an isolated consumer. Check ESM and browser entry points, generated bundle presence, license files, and removal.
...
|---|---|---|---|---|
| 2026-09-24 | `be5d53bc928b9ed641332db48d849354d0d5d0bb` | Created six-section register and README link. No closures. | 30 Node tests passed. The browser pixel sweep was not executed. | Full audit, installed workflows, current rendered parity, platforms, and releases remain unqualified. |
